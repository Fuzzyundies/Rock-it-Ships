...
function ship.new(name)
  ...
  physics.addBody(self.body,"dynamic", {radius = 25, bounce = 0.5, filter = playerCollisionFilter})
...
function ship:fire()
	...
	physics.addBody( self.laser, "dynamic", {radius = 25, bounce = 0.5, filter = laserCollisionFilter} )
...
function ship:breakShield()
	...
	--timer.performWithDelay( 20000, self:restoreShield())
	self:restoreShield()
...
local function createAsteroid()
	...
	physics.addBody(newAsteroid,"dynamic", { radius = 65, bounce = 1.5, filter = asteroidCollisionFilter})
...
function scene:create( event )
	...
	player1ScoreText = display.newText(uiGroup, "Player 1 Score: ".. player1Score, 100, 20, native.SystemFont, 20)
	player2ScoreText = display.newText(uiGroup, "Player 2 Score: ".. player2Score, display.contentWidth - 100, 20, native.SystemFont, 20)
