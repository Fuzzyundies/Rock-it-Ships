				...
				if (obj2.health <= 0) then
					...
					if (player1.lives == 0 or player2.lives == 0) then
						...
						elseif (player1.lives < player2.lives) then
							...
							winnerText = display.newText( uiGroup, "DRAW", display.contentWidth/2, 150, inputText, 30 )
						end
					timer.performWithDelay( 4000, endGame )
					end
				end
...
function scene:create( event )
	...
	playerLivesText = display.newText(uiGroup, "Player 1 Lives: ".. player1.lives, 200, 20, inputText, 20)
	player1LivesText = display.newText(uiGroup, "Player 2 Lives: ".. player2.lives, display.contentWidth - 200, 20, inputText, 20)
